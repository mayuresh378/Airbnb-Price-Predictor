...
class DataTransformation:
    ...
    def initialize_data_transformation(self,train_path,test_path):
        try:
            ...
            train_df['host_response_rate'] = train_df.loc[train_df['host_response_rate'].notna(), 'host_response_rate'].str.replace('%', '').astype(int)
            test_df['host_response_rate'] = test_df.loc[test_df['host_response_rate'].notna(), 'host_response_rate'].str.replace('%', '').astype(int)
