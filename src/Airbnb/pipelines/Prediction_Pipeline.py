...
class PredictPipeline:
    ...
    def predict(self, features):
        try:
            preprocessor_path = os.path.join(self._root_dir, "Artifacts", "Preprocessor.pkl")
            model_path = os.path.join(self._root_dir, "Artifacts", "Model.pkl")
...
class CustomData:
    ...
    def get_data_as_dataframe(self):
        try:
            ...
            numeric_cols = ['amenities', 'accommodates', 'bathrooms', 'latitude', 'longitude', 'host_response_rate', 'number_of_reviews', 'review_scores_rating', 'bedrooms', 'beds']
